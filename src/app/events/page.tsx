...
const EventsPage = () => {
  ...
  const pastEvents = events.filter(event => new Date(event.date).getTime() <= currentDate)
    .sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()); // Sort past events in reverse chronological order
      ...
      >
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            Check out the events that have already taken place.
          </p>
        </motion.div>
